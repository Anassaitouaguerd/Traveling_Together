            ...
            <div class="row g-3">
                <div class="col-sm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="prix" name="prix" placeholder="prix" step="0.1"
                            required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-sm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="gare_depart" id="gare_depart" class="form-control"
                            placeholder="gare depart" required>
                        <div id="res"
                            style="max-height:33vh ;overflow:auto;position:absolute;background-color:white;width:100%;z-index:100;">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="gare_arrivee" id="gare_arrivee" placeholder="gare arrivee"
                ...
                <div class="col-sm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="gare_depart_roteur" placeholder="gare depart"
                            disabled>
                        <label for="gare_depart" class="col-form-label">gare arrivee:</label>
                        <input type="text" class="form-control" id="gare_arrivee_roteur" placeholder="gare arrivee"
                            disabled>
                    </div>
                </div>
            </div>
            <div class="mt-3 d-flex justify-content-center mb-3">
                <button type="submit" class="btn text-light px-5 bg-primary"
                    style="background-color:var(--aqua);border-radius: 20px;" name="saveVoyage">Save</button>
            </div>
            </div>
        </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../include/handlers/voyagehandler.php" method="POST" class="needs-validation"
                        ...
                        <div class="form-group">
                            <label for="datetime" class="col-form-label">datetime:</label>
                            <input type="datetime-local" class="form-control" id="md_datetime" name="md_datetime"
                                required>
                        </div>
