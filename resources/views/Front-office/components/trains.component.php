...
<body>
    <div class="container">
        <div class="py-5">
            <form action="../include/handlers/trainHandler.php" method="post" class="p-lg-5  needs-validation"
                id="add_train_form" novalidate>
                <div class="row gy-3">
                    <div class="col-lg-6 text-start" style="position: relative;">
                        ...
                        <input class="form-control" type="text" name="nom_train" id="nom_train"
                            placeholder="exemple : train v1.." autocomplete="nope" required>
                    ...
                    <div class="col-lg-6 text-start" style="position: relative;">
                        ...
                        <input class="form-control " type="text" name="id_gare" id="id_gare"
                            placeholder="exemple : Gare tanger ville.." autocomplete="false" required>
                        <div class="rounded-bottom"
                            style="background-color:aliceblue;position:absolute;z-index: 1000; width: 94%;max-height:31vh;overflow:auto;"
                            id="cities_rst2"></div>
                    ...
                    <div class="text-start">
                        <button type="submit" class="btn text-light px-5"
                            style="background-color:var(--aqua);border-radius: 20px;" name="save-train">save</button>
                    </div>
                </div>
            </form>
        </div>

        <div class=' alert alert-dismissible fade show' role='alert' style='display: none;background-color: #dff9ff'
            id="train_msg_alert">
