                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                            ...
                            <form id="login" action="/login" class="needs-validation py-5" method="POST">
                                ...
                                <div>
                                    ...
                                    <h4 class="fw-bold mb-5 pb-3" style="letter-spacing: 1px;">Login into your account
                                    </h4>
                                </div>
                                <div class="text-start">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="password" id="password" name="password" class="form-control shesh"
                                            required />
                                            <div class="text-danger">
                                                @error('password')
                                                    {{ $message }}
                                ...
                                <div>
                                    ...
                                    <p>forgot my password? <a class="text-decoration-none" href="/forgotPage">Forgot</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
