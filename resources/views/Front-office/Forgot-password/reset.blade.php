                ...
                <div class="col-lg-6 mb-5 mb-lg-0 ">
                    <div class="card ">
                        <div class="card-body px-4 py-5 px-md-5">
                            ...
                            <form id="login" action="" class="needs-validation py-5" method="POST">
                                @csrf
                                <div>
                                ...
                                <div class="text-start">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3">Confirme Password</label>
                                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control shesh"
                                            required />
                                        <div class="valid-feedback">
                                            Looks Good!
                                        </div>
