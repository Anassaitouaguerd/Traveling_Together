        ...
        <div class="container mt-5">
            ...
            <div class="row mb-5">
                <div class="col-lg-6 text-start" style="position: relative;">
                    ...
                    <input class="form-control" type="text" name="gare_name" id="name"
                        placeholder="Entrer le nom du Gare" autocomplete="off">
                </div>
                <div class="col-lg-6 text-start" style="position: relative;">
                    <label for="" class="form-label ms-2">VILLE</label>
                    <input class="form-control " type="text" name="gare_ville" id="ville" autocomplete="off"
                ...
                <div class="mt-2 d-flex justify-content-center">
                    <button type="submit" class="btn text-light px-5"
                        style="background-color:var(--aqua);border-radius: 20px;" name="saveGare">Add Gare</button>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form action="../include/handlers/garehandler.php" method="POST">
                        ...
                        <div class="form-group">
                            <div class="col-lg-6 text-start" style="position: relative;">
                                <label for="" class="form-label ms-2">NOM DU GARE</label>
                                <input class="form-control" type="text" name="gare_name" id="gare_name"
                                    placeholder="Entrer le nom du Gare" autocomplete="off">
                            </div>
                            <div class="col-lg-6 text-start mt-2" style="position: relative;">
                                <label for="" class="form-label ms-2">VILLE</label>
                                <input class="form-control " type="text" name="gareville" id="gare_ville"
                                    autocomplete="on" placeholder="Entrer le nom du Ville">
                                <div id="md_gareres"
                                    style="max-height:33vh ;overflow:auto;position:absolute;background-color:white;width:100%;z-index:100;">
                                </div>
